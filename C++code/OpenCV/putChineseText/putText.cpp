...
int main()
{
	...
	putTextZH(img, "a微软雅黑字体换...\n行，斜体，下划线，显示!", \
		Point(50, 150), Scalar(0xd6, 0x9d, 0x85), 24, "微软雅黑", true, true);
	putTextZH(img, "d楷体字体换...\n行，斜体，下划线，显示!", \
		Point(100, 250), Scalar(0xb0, 0xc9, 0x4e), 26, "楷体", true, true);
	putTextZH(img, "d宋体字体换...\n行，下划线，显示!", \
		Point(1100, 450), Scalar(0xb0, 0xc9, 0x4e), 30, "宋体", false, true);
